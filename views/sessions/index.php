...
function buildTimeSelects() {
  ...
  // Pré-sélectionner début 08:00 fin 09:00 par défaut
  start.value = '08:00';
  filterEndTimes();
...
function filterEndTimes() {
  ...
  // Ré-sélectionner la valeur précédente si encore valide
...
document.getElementById('nsRoom').addEventListener('change', function() {
  ...
  // Si une seule disposition, la sélectionner automatiquement
  if (plans.length === 1) {
